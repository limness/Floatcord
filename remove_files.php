<?php
	...
	$sql_total = "INSERT INTO logs_id_remove (id_channel_for_delete, txt) VALUES ('$id_channel_search', '0')";
	...
	if($insert['userscount'] < 1) {
		...
		if($id_channel_search != 777 && $insert['vip_status'] != 1) {
			...
			$query = "DELETE FROM channels_files WHERE id_channel = '". $id_channel_search. "'";
